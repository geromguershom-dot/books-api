...
const {
  getAllBooks, getStats, getLowStock,
  getBookById, createBook, updateBook,
  adjustStock, deleteBook,
 ...
 * /api/books/{id}:
 *   put:
 *     summary: Mise à jour complète d'un livre
 *     tags: [Books]
 *     parameters:
 *       - in: path
 *         name: id
 ...
 * /api/books/{id}/stock:
 *   patch:
 *     summary: Ajuster le stock (BONUS)
 *     tags: [Books]
 *     parameters:
 *       - in: path
 *         name: id
